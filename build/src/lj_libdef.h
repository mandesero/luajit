...
#ifdef LJLIB_MODULE_misc
#undef LJLIB_MODULE_misc
static const lua_CFunction lj_lib_cf_misc[] = {
  lj_cf_misc_getmetrics
};
static const uint8_t lj_lib_init_misc[] = {
203,57,1,10,103,101,116,109,101,116,114,105,99,115,255
};
#endif

#ifdef LJLIB_MODULE_misc_sysprof
#undef LJLIB_MODULE_misc_sysprof
static const lua_CFunction lj_lib_cf_misc_sysprof[] = {
  lj_cf_misc_sysprof_start,
  lj_cf_misc_sysprof_stop,
  lj_cf_misc_sysprof_report
};
static const uint8_t lj_lib_init_misc_sysprof[] = {
204,57,3,5,115,116,97,114,116,4,115,116,111,112,6,114,101,112,111,114,116,255
};
#endif

#ifdef LJLIB_MODULE_misc_memprof
#undef LJLIB_MODULE_misc_memprof
static const lua_CFunction lj_lib_cf_misc_memprof[] = {
  lj_cf_misc_memprof_start,
  lj_cf_misc_memprof_stop
};
static const uint8_t lj_lib_init_misc_memprof[] = {
207,57,2,5,115,116,97,114,116,4,115,116,111,112,255
};
#endif
